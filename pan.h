...
#define PanSource	"exercise4_part2.pml"
...
#define nstates2	14	/* p1 */
#define endstate2	13
short src_ln2 [] = {
	  0,  32,  34,  34,  34,  35,  35,  33, 
	 37,  33,  37,  38,  39,  40,   0, };
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "exercise4_part2.pml", 1, 13 },
	{ "-", 14, 15 }
};
uchar reached2 [] = {
	  0,   0,   1,   0,   0,   1,   1,   0, 
...
#define nstates1	14	/* p0 */
#define endstate1	13
short src_ln1 [] = {
	  0,  19,  21,  21,  21,  22,  22,  20, 
	 24,  20,  24,  25,  26,  27,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "exercise4_part2.pml", 1, 13 },
